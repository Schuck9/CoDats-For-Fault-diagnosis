...
class Dataset:
    ...
    def load_tfrecords(self, filenames, batch_size, count=False, evaluation=False):
        ...
        filenames = os.path.join("./datasets/datasets/tfrecords",filenames)
...
def load(dataset_name, num_domains, test=False, train_on_everything=False,
    ...
    #2020.11.13 17:54
    train_filenames = tfrecord_filename(dataset_name, "train")
    valid_filenames = tfrecord_filename(dataset_name, "valid")
    test_filenames = tfrecord_filename(dataset_name, "test")
